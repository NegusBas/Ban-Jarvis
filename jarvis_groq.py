...
def create_excel_sheet(filename, context):
    print(f"📊 CREATING EXCEL: {filename}")
    try:
...
def generate_code_project(project_name, stack):
    print(f"💻 GENERATING PROJECT: {project_name} ({stack})")
    ...
    if "react" in stack.lower():
        ...
        return f"✅ React Native project created."
        ...
        return f"✅ Swift project created."
    return "✅ Project folder created."
...
class MainWindow(QMainWindow):
    ...
    def add_ai_msg(self, t): self.chat.append(f"🤖 {t}")
